 ...
 */
class Task extends \Workflow\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'context', 'name', 'description', 'address', 'parameters', 'createdDate', 'createdBy', 'updatedDate', 'updatedBy');
        }
