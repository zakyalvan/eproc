 ...
 */
class Dokumen {
	const DOKUMEN_KONTRAK_UTAMA = 'KONTRAK_UTAMA';
	const DOKUMEN_LAMPIRAN_A_PERSYARATAN_KHUSUS = 'PERSYARATAN_KHUSUS';
	const DOKUMEN_LAMPIRAN_B_LINGKUP_PEKERJAAN = 'LINGKUP_PEKERJAAN';
	const DOKUMEN_LAMPIRAN_C_HARGA_PEMBAYARAN = 'HARGA_PEMBAYARAN';
	const DOKUMEN_LAMPIRAN_C_PERSYARATAN_UMUM = 'PERSYARATAN_UMUM';
