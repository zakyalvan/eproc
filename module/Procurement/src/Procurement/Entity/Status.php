...
class Status {
	...
	const KODE_TIDAK_LOLOS_VERIFIKASI_ = -7;
	const KODE_TIDAK_LULUS_EVALUASI_TEKNIS = -5;
	const KODE_TIDAK_LOLOS_VERIFIKASI = -4;
	const KODE_TIDAK_MENGIRIM_PENAWARAN = -3;
	const KODE_TIDAK_MENGIKUTI_PENGADAAN_ = -2;
	const KODE_TIDAK_MENGIKUTI_PENGADAAN = -1;
	const KODE_BELUM_MENDAFTAR = 1;
	const KODE_BELUM_MENGIRIM_PENAWARAN_ = 2;
	const KODE_EDIT_ATAU_KIRIM_ULANG_PENAWARAN_ = 3;
	const KODE_LOLOS_VERIFIKASI_ = 4;
